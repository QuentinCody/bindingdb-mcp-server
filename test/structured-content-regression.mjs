...
console.log(`${BLUE}🧪 BindingDB Structured Content Regression Tests${RESET}`);
...
assertContains('src/index.ts', indexContent, 'BindingdbDataDO', 'index.ts exports BindingdbDataDO');
...
console.log(`\n${GREEN}✅ BindingDB structured content regression tests passed.${RESET}`);
